...
def main():
    ...
    scripts = [
        ['python3', '/home/vidyav2/WorldModels_PyTorch_Implementation/data/generation_script.py', '--rollouts', '5000', '--rootdir', 'datasets/carracing', '--threads', '8'],
        ['python3', '/home/vidyav2/WorldModels_PyTorch_Implementation/trainvae.py'],
        ['python3', '/home/vidyav2/WorldModels_PyTorch_Implementation/trainmdrnn.py'],
        ['python3', '/home/vidyav2/WorldModels_PyTorch_Implementation/traincontroller.py', '--logdir', './logs', '--n-samples', '4', '--pop-size', '4', '--target-return', '950', '--display']
